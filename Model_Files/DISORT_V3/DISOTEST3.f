c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
c $Rev: 83 $ $Date: 2017-04-09 15:04:15 -0400 (Sun, 09 Apr 2017) $
c FORTRAN 77
c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
c     ** DISORT I/O specifications
      ...
      PARAMETER ( MAXCLY = 30, MAXMOM = 999, MAXPHI = 5, MAXULV = 30,
     &            MAXUMU = 10 )
...
c     ** Correct answers
      ...
      PARAMETER  ( MXPROB = 16, MXCASE = 8, MXTAU = 30, MXMU = 15,
     &             MXPHI = 5 )
...
c **********************************************************************
     ...
     &                 BDR_BEAM_ANALYTIC,  
     &                 DO_PSEUDO_SPHERE, EARTH_RADIUS, H_LYR(0:NLYR))
...
c Argument 1 is number of layers
         CALL  getarg(1,argument)
         READ(argument,'(I10.00)') NLYR
         print *, 'NLYR = ', NLYR

c Argument 2 is Assymetry parameter 
      DO i = 2, NLYR+1
         CALL getarg(i,argument)
         READ(argument,'(f16.16)') gaea(i-1)
      END DO 
         print *, 'gaea = ', gaea
         
      DO i = NLYR+2,NLYR*2 +1  
         call getarg(i,argument)
         READ(argument,'(f16.16)') DTAUC(i-NLYR-1)
      END DO 
         print *, 'DTAUaea = ', DTAUC

       DO i = NLYR*2 +2, NLYR*3 +1
         call getarg(i,argument)
         READ(argument,'(f16.16)') SSALB(i-(2*NLYR)-1)
       END DO 
         print *, 'SSALB = ', SSALB

         CALL getarg(3*NLYR+2,argument)
         READ(argument,'(f15.15)') FBEAMa
         print *, 'FBEAMa = ', FBEAMa
      ...
      DO i = 1, NLYR
         ...
         CALL  GETMOM( 3, gaea(i), NMOM, PMOM(0,i) )
...
c         WRITE( *,'(0P,F11.4,1P,4E15.4)')  UTAU(LU), RFLDIR(LU),
         WRITE( *,'(0P,F14.12,1P,4E32.12)')  UTAU(LU), RFLDIR(LU),
...
c     .. Parameters ..
      ...
      INTEGER   MXPROB, MXCASE, MXTAU, MXMU, MXPHI
      PARAMETER ( MXPROB = 16, MXCASE = 8, MXTAU = 5, MXMU = 15,
     &            MXPHI = 5 )
c     ..
c     .. Local Scalars ..
